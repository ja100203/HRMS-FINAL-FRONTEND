 ...
 <div className="d-flex" style={{position:'absolute', right:'-160px', top:'180px'}}>
      ...
      <div className="table-start-container">
        ...
        <tbody className="text-center">
          { promotion.length === 0 ? renderPromotionData() : (rowsPerPage > 0
            ? promotion.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
            : promotion
          )
          .filter((elem)=>{
            if(search.length===0)
              ...
              elem.promotionTitle.toLowerCase().includes(search.toLocaleLowerCase()) ||
              elem.promotionDate.toLowerCase().includes(search.toLocaleLowerCase()) ||
              elem.description.toString().toLowerCase().includes(search.toLocaleLowerCase()) 
              )
          }).map((promotion, index) => (
              <tr key={index}>
                ...
                <td className="mx-2">
                    ...
                    <FaTrashAlt className='action-delete' onClick={() => handleDelete(promotion.promotionsId)}
                    />
                </td>
              </tr>
            ))}

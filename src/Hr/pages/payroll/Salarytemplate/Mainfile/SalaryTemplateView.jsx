      ...
      <div className="dashboard-container">
        ...
        <div className="head-foot-part">
          <section>
              ...
              <div style={{ marginTop: "60px", width: "150px" }}>
                ...
                >
                  ...
                  <div style={{ padding: "2px" }}>
                    ...
                    <span style={{ color: "black" }}> Salary Template</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <SalaryTemplateTable salary={salary} setRecDelete={setRecDelete} setFormVisible={setFormVisible} toggle={toggle} setToggle={setToggle}/>
          </section>
        </div>
      </div>
    </div>
